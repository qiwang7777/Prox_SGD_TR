...
from .Saturation_smoothing import SmoothedSaturationLeastSquares
...
def build_tv_saturation_problem_smoothing(
    n=128,
    sigma=2.0,
    kernel_size=9,
    noise_level=0.01,
    ...
    obj_smooth = SmoothedSaturationLeastSquares(
        b=b,
        A_apply=A_apply,
        AT_apply=AT_apply,
        x_true=x_true,
...
def build_l1_saturation_problem_smoothing(
    n=128,
    sigma=2.0,
    kernel_size=9,
    noise_level=0.01,
...
def build_wavelet_l1_saturation_problem_smoothing(
    n=128,
    sigma=2.0,
    kernel_size=9,
    noise_level=0.01,
